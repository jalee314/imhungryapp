...
const TermsConditionsPage = () => {
  ...
  const termsData = [
    { type: 'main_title', text: 'Hungri – Terms of Service' },
    { type: 'effective_date', text: 'Effective Date: October 9, 2025' },
    { type: 'paragraph', text: 'Welcome to Hungri. By using our app, you agree to these Terms of Service ("Terms"). Please read them carefully. If you do not agree, you may not use the app.' },
    { type: 'heading', text: '1. About Hungri' },
    { type: 'paragraph', text: 'Hungri is a community-powered platform for discovering and sharing food deals from restaurants, cafes, and food vendors. Users may browse, save, and post deals.' },
    { type: 'heading', text: '2. Eligibility' },
    { type: 'list_item', text: 'You must be at least 13 years old to use Hungri.' },
    ...
    { type: 'paragraph', text: 'Reported content is reviewed by our team and may be removed. Hungri reserves the right to remove or restrict content or accounts that violate these Terms.' },
    { type: 'heading', text: '6. Privacy and Data' },
    { type: 'paragraph', text: 'Our Privacy Policy explains how we collect, use, and protect your information. By using Hungri, you also agree to our Privacy Policy.' },
    ...
    { type: 'paragraph', text: 'Hungri is provided "as is" without warranties of any kind. We do not guarantee the accuracy or availability of deals. Always verify details with the restaurant before redeeming.' },
    { type: 'heading', text: '9. Limitation of Liability' },
    { type: 'paragraph', text: 'To the maximum extent permitted by law, Hungri is not liable for any damages resulting from your use of the app, including inaccurate deals, technical issues, or third-party actions.' },
    { type: 'heading', text: '10. Changes to Terms' },
    { type: 'paragraph', text: 'We may update these Terms from time to time. Continued use of Hungri after updates means you agree to the revised Terms.' },
