 ...
 * Vote Service (Facade)
 *
 * Public API for vote-related operations. This service maintains backward
 * compatibility with existing callers while the underlying logic is being
 * consolidated in src/features/interactions.
 *
